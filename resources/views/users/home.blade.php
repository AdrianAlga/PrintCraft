              ...
              <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="4000">
                    <img src="{{ asset('/images/slide1.png') }}" class="d-block w-100" alt="img" height="300px" />
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="{{ asset('/images/slide2.png') }}" class="d-block w-100" alt="img" height="300px" />
                  </div>
                  <div class="carousel-item" data-bs-interval="4000">
                    <img src="{{ asset('/images/slide3.png') }}" class="d-block w-100" alt="img" height="300px" />
                  </div>
                </div>
              </div>
            </div>
